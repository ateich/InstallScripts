...
then
  ...
  #nohup sudo mesos-slave --master=zk://10.9.0.1:2181/var/zookeeper/ --ip=$currentIP --port=5051 --attributes=$2 0 &
  sudo mesos-slave --master=zk://10.9.0.1:2181/var/zookeeper/ --ip=$currentIP --port=5051 --attributes=$2 0<&- &>mesos.log &
else
  echo 'KILL MESOS!'
  $1
fi
